...
public class ParametresTable{
    private static ParametresTable INSTANCE;
    ...
    private ParametresTable(SQLiteDatabase database) {
        this.database = database;
        createTable();
    }

    public static ParametresTable createInstance(SQLiteDatabase database){
        if (INSTANCE == null){
            INSTANCE = new ParametresTable(database);
        }
        return INSTANCE;
    }

    public static ParametresTable getInstance() {
        return INSTANCE;
    }
    ...
    public boolean insertParams(String login, String type) {
